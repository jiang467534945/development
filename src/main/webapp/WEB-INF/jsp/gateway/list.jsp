...
<div class="panel">
    <div class="panel-heading">
        <button id="demo-dt-addrow-btn" class="btn btn-info" onclick="addLay('layer_gateway','添加网关','/gateway/add','670px','230px')"><i
    ...
    <form id="form" action="/gateway/list" method="post">
...
<script type="text/javascript">
    ...
    function toEdit(){
        ...
        if(id.length != 1){
            ...
            addLay("layer_edit","修改","/gateway/edit?id="+id,'670px','230px');
        }
    }
</script>
</body>
