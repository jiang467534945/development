...
<head>
    ...
    <!-- CSS INCLUDE -->
    <link rel="stylesheet" type="text/css" id="theme" href="${basePath}/file/css/theme-default.css"/>
    <!-- EOF CSS INCLUDE -->
</head>
<body>
        ...
        <ul class="x-navigation">
            ...
            <li class="xn-profile">
                <a href="http://www.17sucai.com" class="profile-mini">
                    <img src="${basePath}/file/assets/images/users/avatar.jpg" alt="John Doe"/>
                </a>
                <div class="profile">
            ...
            <li class="xn-openable">
                ...
                <ul>
                    ...
                    <li class="xn-openable">
                        <a href="http://www.17sucai.com"><span class="fa fa-file"></span> Blog</a>
            ...
            <li class="xn-openable">
                <a href="http://www.17sucai.com"><span class="fa fa-file-text-o"></span> <span class="xn-text">Layouts</span></a>
                <ul>
                ...
                <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
                    ...
                    <div class="panel-body list-group list-group-contacts scroll" style="height: 200px;">
                        <a href="#" class="list-group-item">
                            ...
                            <img src="${basePath}/file/assets/images/users/user2.jpg" class="pull-left" alt="John Doe"/>
                            <span class="contacts-title">John Doe</span>
                            <p>Praesent placerat tellus id augue condimentum</p>
                        </a>
                        <a href="#" class="list-group-item">
                            <div class="list-group-status status-away"></div>
                            <img src="${basePath}/file/assets/images/users/user.jpg" class="pull-left" alt="Dmitry Ivaniuk"/>
                            <span class="contacts-title">Dmitry Ivaniuk</span>
                            <p>Donec risus sapien, sagittis et magna quis</p>
                        </a>
                        <a href="#" class="list-group-item">
                            <div class="list-group-status status-away"></div>
                            <img src="${basePath}/file/assets/images/users/user3.jpg" class="pull-left" alt="Nadia Ali"/>
                            <span class="contacts-title">Nadia Ali</span>
                            <p>Mauris vel eros ut nunc rhoncus cursus sed</p>
                        </a>
                        <a href="#" class="list-group-item">
                            <div class="list-group-status status-offline"></div>
                            <img src="${basePath}/file/assets/images/users/user6.jpg" class="pull-left" alt="Darth Vader"/>
...
<!-- START PRELOADS -->
<audio id="audio-alert" src="${basePath}/file/audio/alert.mp3" preload="auto"></audio>
<audio id="audio-fail" src="${basePath}/file/audio/fail.mp3" preload="auto"></audio>
<!-- END PRELOADS -->

<!-- START SCRIPTS -->
<!-- START PLUGINS -->
<script type="text/javascript" src="${basePath}/file/js/plugins/jquery/jquery.min.js"></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/jquery/jquery-ui.min.js"></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/bootstrap/bootstrap.min.js"></script>
<!-- END PLUGINS -->

<!-- START THIS PAGE PLUGINS-->
<script type='text/javascript' src='${basePath}/file/js/plugins/icheck/icheck.min.js'></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js"></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/scrolltotop/scrolltopcontrol.js"></script>

<script type="text/javascript" src="${basePath}/file/js/plugins/morris/raphael-min.js"></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/morris/morris.min.js"></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/rickshaw/d3.v3.js"></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/rickshaw/rickshaw.min.js"></script>
<script type='text/javascript' src='${basePath}/file/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'></script>
<script type='text/javascript' src='${basePath}/file/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'></script>
<script type='text/javascript' src='${basePath}/file/js/plugins/bootstrap/bootstrap-datepicker.js'></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/owl/owl.carousel.min.js"></script>

<script type="text/javascript" src="${basePath}/file/js/plugins/moment.min.js"></script>
<script type="text/javascript" src="${basePath}/file/js/plugins/daterangepicker/daterangepicker.js"></script>
<!-- END THIS PAGE PLUGINS-->

<!-- START TEMPLATE -->
<script type="text/javascript" src="${basePath}/file/js/settings.js"></script>

<script type="text/javascript" src="${basePath}/file/js/plugins.js"></script>
<script type="text/javascript" src="${basePath}/file/js/actions.js"></script>

<script type="text/javascript" src="${basePath}/file/js/demo_dashboard.js"></script>
<!-- END TEMPLATE -->
<!-- END SCRIPTS -->
</body>
</html>