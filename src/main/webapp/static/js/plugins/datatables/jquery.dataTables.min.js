    ...
    var S = function(h) {
        ...
        function L(a, b, c, d) {
            ...
            for (var g = a.aoColumns,
                     i = 0,
                     j = g.length; i < j; i++) g[i].sType = null;
        ...
        function B(a, b, c, d) {
            ...
            if (c === k) return a.iDrawError != e && null === i && (J(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}": "'" + f.mData + "'") + " for row " + b, 4), a.iDrawError = e),
                i;
            ...
            var e = [],
                ...
                jb = function(a) {
                    if (c === k || c === j) i = l[j],
                        ...
                        i && i._bAttrSrc ? (Q(i.mData._)(d, n), q(i.mData.sort, a), q(i.mData.type, a), q(i.mData.filter, a)) : r ? (i._setter || (i._setter = Q(i.mData)), i._setter(d, n)) : d[j] = n;
                    j++
                };
            if (f) for (; f;) {
            ...
            if (b) {
                ...
                for (e = g.length; d < e; d++) {
                    ...
                    for (b = g[d].length; f < b; f++) if (n = j = 1, i[d][f] === k) {
                        ...
                        for (i[d][f] = 1; g[d + j] !== k && g[d][f].cell == g[d + j][f].cell;) i[d + j][f] = 1,
                            j++;
        ...
        function ra(a, b, c) {
            ...
            n = {
                ...
                error: function(b, c) {
                    var d = w(a, null, "xhr", [a, null, a.jqXHR]); - 1 === h.inArray(!0, d) && ("parsererror" == c ? J(a, 0, "Invalid JSON response", 1) : 4 === b.readyState && J(a, 0, "Ajax error", 7));
                    C(a, !1)
                }
            };
            a.oAjaxData = b;
            w(a, null, "preXhr", [a, b]);
            a.fnServerData ? a.fnServerData.call(i, a.sAjaxSource, h.map(b,
                function(a, b) {
                    return {
                        name: b,
                        value: a
        ...
        function ub(a) {
            ...
            for (g = 0; g < c; g++) n = b[g],
                ...
                q("mDataProp_" + g, j),
            d.bFilter && (q("sSearch_" + g, l.sSearch), q("bRegex_" + g, l.bRegex), q("bSearchable_" + g, n.bSearchable)),
        ...
        function pb(a) {
            var b = a.oClasses,
                ...
                j = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", g ? ua(f, g) : f).bind("keypress.DT",
                    function(a) {
        ...
        function yb(a) {
            for (var b = m.ext.search,
                     ...
                     d, e, f = 0,
                     g = b.length; f < g; f++) {
                for (var i = [], j = 0, n = c.length; j < n; j++) e = c[j],
                    d = a.aoData[e],
        ...
        function zb(a) {
            ...
            for (f = a.aoData.length; d < f; d++) if (h = a.aoData[d], !h._aFilterData) {
                ...
                for (g = b.length; e < g; e++) c = b[e],
                    c.bSearchable ? (j = B(a, d, e, "filter"), l[c.sType] && (j = l[c.sType](j)), null === j && (j = ""), "string" !== typeof j && j.toString && (j = j.toString())) : j = "",
                j.indexOf && -1 !== j.indexOf("&") && (wa.innerHTML = j, j = Zb ? wa.textContent: wa.innerText),
        ...
        function ob(a) {
            ...
            h("select", j).val(a._iDisplayLength).bind("change.DT",
                function() {
                    Ra(a, h(this).val());
                    M(a)
                });
        ...
        function Z(a) {
            ...
            if (E.outerWidth() < f) {
                ...
                if (w && (i.scrollHeight > i.offsetHeight || "scroll" == l.css("overflow-y"))) t.width = u(s - b); ("" === c || "" !== d) && J(a, 1, "Possible column misalignment", 6)
            } else s = "100%";
            k.width = u(s);
            g.width = u(s);
            N && (a.nScrollFoot.style.width = u(s)); ! e && w && (k.height = u(p.offsetHeight + b));
            c = E.outerWidth();
            n[0].style.width = u(c);
            j.width = u(c);
        ...
        function H(a, b, c) {
            for (var d = 0,
                     ...
                     g, i; e < f;) {
                g = b[e].firstChild;
                for (i = c ? c[e].firstChild: null; g;) 1 === g.nodeType && (c ? a(g, i, d) : a(g, d), d++),
                    g = g.nextSibling,
        ...
        function Ha(a) {
            ...
            if (d || !q && !f && !e && i == ca(a) && i == n.length) for (m = 0; m < i; m++) {
                ...
                if (f) {
                    for (m = g = 0; m < j.length; m++) o = c[j[m]],
                        e = p.bBounding ? n[m].getBoundingClientRect().width: h(n[m]).outerWidth(),
                        g += null === o.sWidthOrig ? e: parseInt(o.sWidth, 10) + e - h(n[m]).width();
                    i.width(u(g));
                    b.style.width = u(g)
                }
            ...
            if ("ssp" != y(a) && 0 !== h.length) {
                ...
                g === h.length ? j.sort(function(a, b) {
                    ...
                    var c, g, i, j, k = h.length,
                        m = f[a]._aSortData,
                        p = f[b]._aSortData;
                    for (i = 0; i < k; i++) if (j = h[i], c = m[j.col], g = p[j.col], j = e[j.type + "-" + j.dir] || e["string-" + j.dir], c = j(c, g), 0 !== c) return c;
                    c = d[a];
                    g = d[b];
        ...
        function Jb(a) {
            for (var b, c, d = a.aoColumns,
                ...
                c.bSortable && (0 < e.length && e[0].col == f ? (j.setAttribute("aria-sort", "asc" == e[0].dir ? "ascending": "descending"), c = i[e[0].index + 1] || i[0]) : c = i[0], b += "asc" === c ? a.sSortAscending: a.sSortDescending);
        ...
        function Ib(a, b) {
            ...
            for (var f, g = m.ext.type.order[c.sType + "-pre"], i = 0, h = a.aoData.length; i < h; i++) if (c = a.aoData[i], c._aSortData || (c._aSortData = []), !c._aSortData[b] || d) f = d ? e[i] : B(a, i, b, "sort"),
        ...
        function Kb(a) {
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (e && e.time && (b = w(a, "aoStateLoadParams", "stateLoadParams", [a, e]), -1 === h.inArray(!1, b) && (b = a.iStateDuration, !(0 < b && e.time < +new Date - 1E3 * b) && d.length === e.columns.length))) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) J(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    var g = o.asStripeClasses,
                        s = r.children("tbody").find("tr").eq(0); - 1 !== h.inArray(!0, h.map(g,
                        function(a) {
                            return s.hasClass(a)
                    ...
                    z(o, "aoDrawCallback",
                        function() { (o.bSorted || y(o) === "ssp" || v.bDeferRender) && xa(o)
                        },
                        "sc");
                    ...
                    0 === i.length || 0 === i.children().length ? r.addClass(j.sNoFooter) : 0 < i.length && (o.nTFoot = i[0], fa(o.aoFooter, o.nTFoot));
                    if (e.aaData) for (g = 0; g < e.aaData.length; g++) L(o, e.aaData[g]);
                    else(o.bDeferLoading || "dom" == y(o)) && ma(o, h(o.nTBody).children("tr"));
                    o.aiDisplay = o.aiDisplayMaster.slice();
                    o.bInitialised = !0; ! 1 === n && ia(o)
                }
            });
            b = null;
            return this
        ...
        t = function(a, b) {
            ...
            var c = [],
                d = function(a) { (a = cc(a)) && (c = c.concat(a))
                };
                ...
                for (h = l.length; g < h; g++) {
                    ...
                    f !== k && e.push(f);
                        ...
                        for (n = q.length; j < n; j++) f = q[j],
                            f = "cell" === b ? c.call(o, l[g], f.row, f.column, g, j) : c.call(o, l[g], f, g, j, m),
                        f !== k && e.push(f)
                    }
                }
        ...
        t.register = p = function(a, b) {
            ...
            else for (var e = a.split("."), f = Tb, g, i, c = 0, d = e.length; c < d; c++) {
        ...
        var Za = function(a, b, c, d, e) {
            ...
            Da = function(a, b) {
                ...
                } else if ("current" == d || "applied" == d) f = "none" == i ? c.slice() : "applied" == i ? g.slice() : h.map(c,
                    function(a) {
                        ...
                        function(c) {
                            ...
                            return Za("row", a,
                                function(a) {
                                    ...
                                    if (!a) return i;
                                    if (typeof a === "function") return h.map(i,
                                        function(b) {
                                            var e = c.aoData[b];
            ...
            function() {
                ...
                this.iterator("row",
                    function(b, c, d) {
                        ...
                        e.splice(c, 1);
                        for (var g = 0,
                                 h = e.length; g < h; g++) null !== e[g].nTr && (e[g].nTr._DT_RowIndex = g);
                ...
                var b = this.iterator("table",
                    function(b) {
                        ...
                        for (g = a.length; f < g; f++) c = a[f],
                            c.nodeName && "TR" === c.nodeName.toUpperCase() ? h.push(ma(b, c)[0]) : h.push(L(b, c));
                        return h
                    },
                    1),
                    c = this.rows( - 1);
                    ...
                    function(c, d) {
                        ...
                        if (a !== k && f.bVisible !== a) {
                            if (a) {
                                ...
                                i = 0;
                                for (j = g.length; i < j; i++) m = g[i].nTr,
                                    e = g[i].anCells,
                            ...
                            function(a) {
                                ...
                                return h.isPlainObject(a) ? [a] : j.filter(a).map(function(a, b) {
                                    if (b.parentNode) l = b.parentNode._DT_RowIndex;
                                        ...
                                        a = 0;
                                        for (t = f.length; a < t; a++) if (h.inArray(b, f[a].anCells) !== -1) {
                                            l = a;
                                            break
                                        }
                                    }
            ...
            function(a) {
                ...
                return this.iterator("table",
                    function(b) {
                        ...
                        g = a ? "remove": "detach";
                        j[g]();
                        k[g](); ! a && c && (c.insertBefore(e, b.nTableReinsertBefore), j.css("width", b.sDestroyWidth).removeClass(d.sTable), (p = b.asDestroyStripes.length) && f.children().each(function(a) {
